...
My question is, when data-driven rules fail to recognise human diversity, who should have the power to grant exceptions? 

I choose this question because it shifts the debate from whether exceptions should exist to who decides when they are justified. The algorithm’s designer could integrate this difference back into the model, the institution using it can audit past decisions to remedy them, and the affected individual can receive their "right" outcome.
